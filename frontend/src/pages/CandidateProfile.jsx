        ...
        <div className="flex justify-between items-center mb-6 print:hidden">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="text-xs font-semibold bg-white hover:bg-slate-50 text-slate-700 px-3 py-2 rounded-lg border border-slate-200 shadow-sm transition-all cursor-pointer font-bold"
            >
              Compartir Perfil
            </button>
            <button
              onClick={() => window.print()}
              className="text-xs font-semibold bg-blue-700 hover:bg-blue-800 text-white px-3 py-2 rounded-lg border border-transparent shadow-sm transition-all cursor-pointer font-bold"
            >
              Descargar PDF
            </button>
          </div>
